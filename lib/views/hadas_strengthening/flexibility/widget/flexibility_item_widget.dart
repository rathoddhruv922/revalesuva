...
class FlexibilityItemWidget extends StatelessWidget {
  const FlexibilityItemWidget({super.key, required this.data, required this.index});

  final flexibility_model.Datum data;
  final int index;
