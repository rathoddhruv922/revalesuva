...
class NutritionalInformationItem extends StatelessWidget {
  const NutritionalInformationItem({super.key, required this.data, required this.index, required this.onTap});
