...
class TechnicalSupportListView extends StatefulWidget {
  const TechnicalSupportListView({super.key});

  @override
  State<TechnicalSupportListView> createState() => _TechnicalSupportListViewState();
}

class _TechnicalSupportListViewState extends State<TechnicalSupportListView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await makingContactViewModel.fetchTechnicalSupport();
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvokedWithResult: (didPop, result) {
        NavigationHelper.onBackScreen(widget: const TechnicalSupportListView());
      },
      canPop: true,
      child: Scaffold(
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            NavigationHelper.pushScreenWithNavBar(
                widget: const TechnicalSupportView(), context: context);
          },
        ),
        body: Padding(
                  ...
                  () => makingContactViewModel.isLoading.value
                      ...
                      : (makingContactViewModel.listMessage.isNotEmpty)
                          ? RefreshIndicator(
                              onRefresh: () {
                                makingContactViewModel.currentPage.value = 1;
                                return makingContactViewModel.fetchTechnicalSupport();
                              },
