...
class QuestionProgressWidget extends StatelessWidget {
  const QuestionProgressWidget({super.key, required this.value, required this.max});
        ...
        children: [
          Directionality(
            ...
            child: SliderTheme(
              ...
              child: Slider(
                value: value + 1,
                // Adjusting the value to start from 1
                max: max,
                // Adjusting the max to end at 10
                min: 1,
                // Setting the minimum to 1
                allowedInteraction: SliderInteraction.tapOnly,
                activeColor: AppColors.surfaceGreen,
                inactiveColor: AppColors.surfaceTertiary.withValues(alpha: 0.5),
