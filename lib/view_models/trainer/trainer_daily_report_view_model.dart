...
class TrainerDailyReportViewModel extends GetxController {
  ...
  fetchDailyReportList({
    ...
    try {
      ...
      var response = await Repository.instance.getCustomerDailyReportListApi(
        perPage: perPage,
        customerId: customerId,
  ...
  fetchUserDailyReportAns({required String date, required String customerId}) async {
    var response = await Repository.instance.getCustomerDailyReportDataApi(
      date: date,
      customerId: customerId,
    );
    listUserAns.clear();
